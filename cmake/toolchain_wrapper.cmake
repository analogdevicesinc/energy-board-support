...
if(EVB MATCHES "app_mcu_h5")
  set(TOOLCHAIN_PATH "${STM32CLT_PATH}/GNU-tools-for-STM32/bin" CACHE PATH "Toolchain path")
  set(SDK C:/ST/STM32CubeH5/Drivers/STM32H5xx_HAL_Driver CACHE PATH "Path to STM32H5 Drivers directory")
...
elseif(EVB MATCHES "eval_ade9178")
  ...
  set(TOOLCHAIN_PATH "${SDK}/Tools/GNUTools/10.3/bin" CACHE PATH "Toolchain path")
...
elseif(EVB MATCHES "app_mcu_h7")
  set(SDK C:/ST/STM32CubeH7/Drivers/STM32H7xx_HAL_Driver CACHE PATH "Path to STM32H7 Drivers directory")
  set(TOOLCHAIN_PATH "${STM32CLT_PATH}/GNU-tools-for-STM32/bin" CACHE PATH "Toolchain path")
