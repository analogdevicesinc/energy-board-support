...
/**
 * @file  stm32h735xx_spi_config.h
 * @brief SPI sample configuration for STM32H735xx
 * @addtogroup    SPI drivers
 * @{
 */

#ifndef __STM32H735XX_SPI_CONFIG_H__
#define __STM32H735XX_SPI_CONFIG_H__
...
#endif /* __STM32H735XX_SPI_CONFIG_H__ */
