...
/**
 * @file  stm32h563xx_uart_config.h
 * @brief UART configuration for STM32H563xx/H573xx
 * @addtogroup    UART drivers
 * @{
 */

#ifndef __STM32H563xx_UART_CONFIG_H__
#define __STM32H563xx_UART_CONFIG_H__
...
#endif /* __STM32H563xx_UART_CONFIG_H__ */
